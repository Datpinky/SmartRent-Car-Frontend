...
import { FaStar, FaRoute, FaSpinner } from 'react-icons/fa';
    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: 14, marginBottom: 16, flexWrap: 'wrap' }}>
        {[
          ...
          { label: 'Tổng doanh thu từ khách', val: totalRevenue.toLocaleString('vi-VN') + 'đ', color: '#00b14f' },
