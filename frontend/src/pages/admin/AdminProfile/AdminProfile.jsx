...
const ACTIVITY_LOG = [
  { id: 1, action: 'Phê duyệt Showroom "Xe Tốt Thủ Đức"',      time: '11/03/2026 09:42' },
  { id: 2, action: 'Khóa tài khoản user ID #5 (Hoàng Văn Em)', time: '10/03/2026 15:20' },
  { id: 3, action: 'Từ chối xe Ford Ranger BKS 51Q-89012',      time: '09/03/2026 11:05' },
  { id: 4, action: 'Duyệt eKYC cho Nguyễn Văn An',             time: '08/03/2026 14:33' },
  { id: 5, action: 'Cập nhật cài đặt hệ thống – Phí DV: 5%',   time: '07/03/2026 10:00' },
];
...
const AdminProfile = () => {
  ...
  const TABS = [
    ...
    ['activity', <FaHistory />,          'Lịch sử hoạt động'],
  ];
      ...
      {tab === 'security' && (
        <div className="ap-card">
          ...
          <div style={{ maxWidth: 440, display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <button className="ap-btn-primary" style={{ alignSelf: 'flex-start' }} onClick={handlePwSave}>
            ...
            {ACTIVITY_LOG.map((item, i) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '0.72rem', color: '#9ca3af', marginTop: 3 }}>{item.time}</div>
                </div>
              </div>
            ))}
          </div>
